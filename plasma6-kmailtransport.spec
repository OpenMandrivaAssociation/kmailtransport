...
Release:	%{?git:0.%{git}.}1
%if 0%{?git:1}
Source0:	https://invent.kde.org/pim/kmailtransport/-/archive/%{gitbranch}/kmailtransport-%{gitbranchd}.tar.bz2#/kmailtransport-20240217.tar.bz2
%else
...
%prep
%autosetup -p1 -n kmailtransport-%{?git:%{gitbranchd}}%{!?git:%{version}}
%cmake \
